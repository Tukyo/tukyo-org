...
const timelineSizes = {
    anchor: { width: pixelSizes.AnchorSize, height: pixelSizes.AnchorSize },
...
const timelineData = {
    nodes: [
        { id: 'a', text: 'Inception of Tukyo', homeX: 1025, homeY: -1000, hoverHTML: 'April 22, 2015', color: timelineColors.KeyColor, ...timelineSizes.anchor, connections: ['b'] },
        ...
        { id: 'h', text: 'Profectio Album & NFT Collection', homeX: 300, homeY: 700, hoverHTML: 'June 21, 2022', color: timelineColors.CodeColor, ...timelineSizes.main, connections: ['i'], subgroup: [
        ...
        { id: 'k', text: 'deSypher on Mainnet', homeX: 900, homeY: 800, hoverHTML: 'June 3, 2024', color: timelineColors.CodeColor, ...timelineSizes.main, connections: ['l'], subgroup: [
        ...
        { id: 'l', text: 'Sypherbot Released', homeX: 500, homeY: 900, hoverHTML: 'November 19, 2024', color: timelineColors.CodeColor, ...timelineSizes.main, connections: ['m'], subgroup: [
        ...
        { id: 'm', text: 'Nibble', homeX: 700, homeY: 900, hoverHTML: 'December 1, 2024', color: timelineColors.MusicColor, ...timelineSizes.main, connections: ['n'], subgroup: [
        ...
        { id: 'n', text: 'You are Here', homeX: 200, homeY: 1000, hoverHTML: 'More Creations Coming Soon!', color: timelineColors.KeyColor, ...timelineSizes.anchor}
    ]
};
// #endregion Data

// #region Youtube Data
const maxVideoBubbleSize = 150;
const minVideoBubbleSize = 25;

const youtubePreviews = "assets/video/youtube/"
